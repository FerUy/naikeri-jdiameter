...
public class S6aPurgeUETest {
  ...
  public S6aPurgeUETest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<S6aPurgeUETest> t = S6aPurgeUETest.class;
