...
public class S6cAlertServiceCentreTest {
  ...
  public S6cAlertServiceCentreTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<S6cAlertServiceCentreTest> t = S6cAlertServiceCentreTest.class;
