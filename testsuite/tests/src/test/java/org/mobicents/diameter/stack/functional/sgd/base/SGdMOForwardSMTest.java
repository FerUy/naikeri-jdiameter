...
public class SGdMOForwardSMTest {
  ...
  public SGdMOForwardSMTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<SGdMOForwardSMTest> t = SGdMOForwardSMTest.class;
