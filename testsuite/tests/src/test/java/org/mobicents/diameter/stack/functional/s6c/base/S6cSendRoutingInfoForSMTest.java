...
public class S6cSendRoutingInfoForSMTest {
  ...
  public S6cSendRoutingInfoForSMTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<S6cSendRoutingInfoForSMTest> t = S6cSendRoutingInfoForSMTest.class;
