...
public class SLhSessionFlowAllAVPsTest {
  ...
  public SLhSessionFlowAllAVPsTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  @Test
  public void testLCSRoutingInfo() {
    try {
  ...
  public static Collection<Object[]> data() {
    ...
    Class<SLhSessionFlowAllAVPsTest> t = SLhSessionFlowAllAVPsTest.class;
