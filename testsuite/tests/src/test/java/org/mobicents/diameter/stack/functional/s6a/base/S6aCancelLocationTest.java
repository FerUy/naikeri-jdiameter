...
public class S6aCancelLocationTest {
  ...
  public S6aCancelLocationTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<S6aCancelLocationTest> t = S6aCancelLocationTest.class;
