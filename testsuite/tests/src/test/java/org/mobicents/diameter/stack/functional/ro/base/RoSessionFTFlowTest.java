...
public class RoSessionFTFlowTest {
   ...
   */
  public RoSessionFTFlowTest(String clientConfigUrl, String serverNode1ConfigURL, String serverNode2ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    String replicatedServer2 = "configurations/functional-ro/replicated-config-server-node2.xml";

    Class<RoSessionFTFlowTest> t = RoSessionFTFlowTest.class;
