...
public class S6aInsertSubscriberDataTest {
  ...
  public S6aInsertSubscriberDataTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<S6aInsertSubscriberDataTest> t = S6aInsertSubscriberDataTest.class;
