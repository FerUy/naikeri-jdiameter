...
public class S6aDeleteSubscriberDataTest {
  ...
  public S6aDeleteSubscriberDataTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<S6aDeleteSubscriberDataTest> t = S6aDeleteSubscriberDataTest.class;
