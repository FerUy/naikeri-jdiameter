...
public class S6aResetTest {
  ...
  public S6aResetTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<S6aResetTest> t = S6aResetTest.class;
