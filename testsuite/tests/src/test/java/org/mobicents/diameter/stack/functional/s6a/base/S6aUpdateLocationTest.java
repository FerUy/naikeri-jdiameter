...
public class S6aUpdateLocationTest {
  ...
  public S6aUpdateLocationTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<S6aUpdateLocationTest> t = S6aUpdateLocationTest.class;
