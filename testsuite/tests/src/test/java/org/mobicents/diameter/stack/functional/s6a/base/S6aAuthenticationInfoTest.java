...
public class S6aAuthenticationInfoTest {
  ...
  public S6aAuthenticationInfoTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<S6aAuthenticationInfoTest> t = S6aAuthenticationInfoTest.class;
