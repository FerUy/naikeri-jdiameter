...
public class RoSessionBasicFlowTest {
   ...
   */
  public RoSessionBasicFlowTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    String server1 = "configurations/functional-ro/config-server-node1.xml";
    ...
    Class<RoSessionBasicFlowTest> t = RoSessionBasicFlowTest.class;
