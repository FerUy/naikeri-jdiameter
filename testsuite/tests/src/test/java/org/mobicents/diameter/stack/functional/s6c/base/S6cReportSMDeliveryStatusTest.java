...
public class S6cReportSMDeliveryStatusTest {
  ...
  public S6cReportSMDeliveryStatusTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<S6cReportSMDeliveryStatusTest> t = S6cReportSMDeliveryStatusTest.class;
