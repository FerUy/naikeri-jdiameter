 ...
 */
public abstract class S6cSession extends AppSessionImpl implements NetworkReqListener, StateMachine {
  ...
  protected transient IS6cMessageFactory messageFactory;

  protected static final String TIMER_NAME_MSG_TIMEOUT = "MSG_TIMEOUT";
  protected IS6cSessionData sessionData;

  public S6cSession(ISessionFactory sf, IS6cSessionData sessionData) {
  ...
  public boolean equals(Object obj) {
    ...
    S6cSession other = (S6cSession) obj;
    if (sessionData == null) {
