...
public class StackImpl implements IContainer, StackImplMBean {
  ...
  @Override
  public void sendMessage(IMessage message, Boolean useRealm) throws RouteException, AvpDataException, IllegalDiameterStateException, IOException {
    peerManager.sendMessage(message, useRealm);
  }
